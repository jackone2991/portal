import { MasterPublic } from "portal-frontend";

// Guest / marketing shell — port of `master/master-public.blade.php`. Minimal
// chrome: it renders {children} + the shared svg sprite and nothing else, so it
// only shows once given children. Here we hand it a centered auth card, the
// typical public-shell payload (login/register/landing).
