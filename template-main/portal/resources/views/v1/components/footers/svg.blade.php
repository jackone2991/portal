    ...
    <!-- SVG icons loader -->
    <script src="{{ asset('v1/js/svg-loader.js') }}"></script>
    <div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
            ...
            <symbol id="olymp-facebook-icon" aria-hidden="true" data-prefix="fab" data-icon="facebook-f" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
            ...
            <symbol id="olymp-star-full" aria-hidden="true" data-prefix="fa" data-icon="star" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0z"></path>
            </symbol>
            <symbol id="olymp-star-null" aria-hidden="true" data-prefix="far" data-icon="star" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <path fill="currentColor" d="M528.1 171.5L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6zM388.6 312.3l23.7 138.4L288 385.4l-124.3 65.3 23.7-138.4-100.6-98 139-20.2 62.2-126 62.2 126 139 20.2-100.6 98z"></path>
            </symbol>
            <symbol id="olymp-dribble-icon" aria-hidden="true" data-prefix="fab" data-icon="dribbble" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <symbol id="olymp-spotify-icon" aria-hidden="true" data-prefix="fab" data-icon="spotify" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
            ...
            <symbol id="olymp-facebook-square" aria-hidden="true" data-prefix="fab" data-icon="facebook-square" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path fill="currentColor" d="M400 32H48A48 48 0 0 0 0 80v352a48 48 0 0 0 48 48h137.25V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.27c-30.81 0-40.42 19.12-40.42 38.73V256h68.78l-11 71.69h-57.78V480H400a48 48 0 0 0 48-48V80a48 48 0 0 0-48-48z"></path>
            </symbol>
            <symbol id="olymp-youtube-icon" aria-hidden="true" data-prefix="fab" data-icon="youtube" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                <path fill="currentColor" d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"></path>
            </symbol>
            <symbol id="olymp-google-plus-g-icon" aria-hidden="true" data-prefix="fab" data-icon="google-plus-g" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
            ...
            <symbol id="olymp-instagram-icon" aria-hidden="true" data-prefix="fab" data-icon="instagram" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <symbol id="olymp-check-icon-small" aria-hidden="true" data-prefix="fa" data-icon="check" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="currentColor" d="M173.898 439.404l-166.4-166.4c-9.997-9.997-9.997-26.206 0-36.204l36.203-36.204c9.997-9.998 26.207-9.998 36.204 0L192 312.69 432.095 72.596c9.997-9.997 26.207-9.997 36.204 0l36.203 36.204c9.997 9.997 9.997 26.206 0 36.204l-294.4 294.401c-9.998 9.997-26.207 9.997-36.204-.001z"></path>
            </symbol>
            <symbol id="olymp-rss-icon" aria-hidden="true" data-prefix="fa" data-icon="rss" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <symbol id="olymp-check-circle" aria-hidden="true" data-prefix="far" data-icon="check-circle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="currentColor" d="M256 8C119.033 8 8 119.033 8 256s111.033 248 248 248 248-111.033 248-248S392.967 8 256 8zm0 48c110.532 0 200 89.451 200 200 0 110.532-89.451 200-200 200-110.532 0-200-89.451-200-200 0-110.532 89.451-200 200-200m140.204 130.267l-22.536-22.718c-4.667-4.705-12.265-4.736-16.97-.068L215.346 303.697l-59.792-60.277c-4.667-4.705-12.265-4.736-16.97-.069l-22.719 22.536c-4.705 4.667-4.736 12.265-.068 16.971l90.781 91.516c4.667 4.705 12.265 4.736 16.97.068l172.589-171.204c4.704-4.668 4.734-12.266.067-16.971z"></path>
            </symbol>
            <symbol id="olymp-circle" aria-hidden="true" data-prefix="fa" data-icon="circle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <path fill="currentColor" d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8z"></path>
            </symbol>
            <symbol id="olymp-back-to-top" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M12.606 8.012L8 3.621v4.383H6V3.621L1.394 8.012-.008 6.676l5.607-5.344L7-.004l7.009 6.68-1.403 1.336zM8 12.004H6v-2h2v2zm0 6H6v-4h2v4z"></path>
            </symbol>
            <symbol id="book-tanakh-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
