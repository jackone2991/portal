    ...
    <div class="fixed-sidebar left">
        <div class="fixed-sidebar-left sidebar--small" id="sidebar-left">
            ...
            <div class="mCustomScrollbar ps ps--theme_default ps--active-x" data-mcs-theme="dark" data-ps-id="39b75a1a-9680-b2d6-be00-66a8c3b5f6f6">
                <ul class="left-menu">
                    <li>
                     ...
                     <li>
                        <a href="">
                            <svg class="olymp-newsfeed-icon left-menu-icon" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Money">
                     ...
                     <li>
                        <a href="./03-Newsfeed.html">
                            <svg class="olymp-newsfeed-icon left-menu-icon" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="PIGGY-BANK">
                                <use xlink:href="#piggy-bank"></use>
                            </svg>
                        </a>
                     </li>
                    <li>
                        <a href="{{route('library.commic')}}">
                            <svg class="olymp-star-icon left-menu-icon" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="library">
                                <use xlink:href="#book-tanakh-icon"></use>
                            </svg>
                        </a>
                    </li>
                    <!-- {{-- <li>
                ...
                <div class="ps__scrollbar-x-rail" style="width: 70px; left: 0px; bottom: 0px;">
                    <div class="ps__scrollbar-x" tabindex="0" style="left: 0px; width: 64px;"></div>
                </div>
        ...
        <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
            ...
            <div class="mCustomScrollbar ps ps--theme_default" data-mcs-theme="dark" data-ps-id="f75c6c46-6a55-5378-8ea7-446b461dbe56">
                <ul class="left-menu">
                    <li>
                        <a href="javascript:void(0)" class="js-sidebar-open">
                    ...
                    <li>
                        <a href="./03-Newsfeed.html">
                            ...
                            <span class="left-menu-title">Personal Bank</span>
                        </a>
                    </li>
                     <li>
                        <a href="{{route('library.commic')}}">
                            ...
                            <span class="left-menu-title">Library</span>
                        </a>
                    </li>
                    <!-- {{-- <li>
                        <a href="./17-FriendGroups.html">
                ...
                <div class="profile-completion">
                    ...
                    <div class="skills-item">
                        ...
                        <div class="skills-item-meter">
                            <span class="skills-item-meter-active bg-primary skills-animate" style="width: 76%; opacity: 1;"></span>
                        </div>
                    </div>
    ...
    <div class="fixed-sidebar left fixed-sidebar-responsive">
        ...
        <div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1-responsive">
            ...
            <div class="mCustomScrollbar ps ps--theme_default" data-mcs-theme="dark" data-ps-id="0edacb36-e31d-8916-4654-adb040a0c3d6">

                <div class="control-block">
                    <div class="author-page author vcard inline-items">
                        <div class="author-thumb">
                            <img alt="author" src="{{asset('v1/ico/author-page.webp')}}" width="36" height="36" class="avatar">
