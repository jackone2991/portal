...
**Status:** current · **Last verified:** 2026-09-12 · written by `/setup-matt-pocock-skills`; edit directly, re-run the skill only to switch trackers
...
as evidence). Issues that arrive raw (bug reports, requests) go through `/triage` first
and get a backlog line only if they survive it. Do not put a work item in only one of
the two.
