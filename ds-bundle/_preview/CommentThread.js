var __dsPreview = (() => {
  ...
  // .design-sync/previews/CommentThread.tsx
  ...
  var Thread = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { "data-template": "v1", style: { background: "#f5f6fa", padding: 16 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "div",
    {
      style: {
        width: 600,
  ...
  return __toCommonJS(CommentThread_exports);
})();
